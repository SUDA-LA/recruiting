...
## 1 2022年招生类别（供参考；2023年还未公布，但是相关专业和方向应该保持不变）
博士：计算机科学与技术、软件工程  
学术型硕士：计算机科学与技术、软件工程  
...
#### 3.2.1 对于相互熟悉的同学
* 如果同学在我的课程班上、或在数据标注项目、或者大创项目等，表现优秀，考察会简化一些。
...
第2个方案最优，但是研二上学期选拔前（10月份左右）就要至少录用一篇CCF-A/B/C类的会议长文，否则选拔时，打分不够的，可以问问师兄姐了解情况。另外，一定要提前看一下政策文件，比如对研究生课程的成绩有什么要求。之前有同学因为单科成绩低于75分而失去直博资格。、
## 5 视频、PPT信息
* 2022年x月x日做的一个介绍小组工作的PPT：
...
* 坚持第一线工作：看论文、推导公式、写论文、看代码（好久不写代码了）、看数据、标数据、分析实验结果；不断提升自己，根据兴趣学习新的东西，例如数学（人生一大乐趣）。自勉：坚持到45岁！
